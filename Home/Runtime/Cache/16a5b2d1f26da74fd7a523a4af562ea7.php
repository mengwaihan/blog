...
.SafeSetting-ouLeft .file{
	...
	<body>
	<form class="form-horizontal" role="form" method="post" action="__URL__/jiawan" enctype="multipart/form-data">
		<div class="ou-body">
			<div class="head">
				<div id='container'>
					<nav>
			...
			<div class="message">
				<div class="message-content">
					...
					<div class="message-input">
						<input class="form-control" name="title" id="title" type="test" value="" />
					</div>
					...
					<input type="hidden" id="obj" name="piclist"/>
					<div class="clear"></div>
					<div id="content">
						<div id="post">
							<textarea class="transition" name="data" id="abc"></textarea>
							<input class="btn btn-info" id="postBt" type="submit" value="提交" />
